...
# ...pay for order...
recv_part_id=$(rq PUT "/order/$order_id/confirm?proofOfPayment=123")
...
recv_part_id1=$(rq PUT "/order/$order_id1/confirm?proofOfPayment=66")
recv_part_id2=$(rq PUT "/order/$order_id2/confirm?proofOfPayment=77")
[ "$part_id" == "$recv_part_id1" ]
[ "$part_id" == "$recv_part_id2" ]


# Retire some parts on behalf of customer, confirming that all have been bought
rq DELETE "/part/$part_id"
